...
import com.cevdetkilickeser.neyicez.presentation.ui.fragment.HomeFragmentDirections
import com.cevdetkilickeser.neyicez.presentation.viewmodel.HomeViewModel

class FoodsAdapter(private val viewModel: HomeViewModel) : ListAdapter<Foods, FoodsAdapter.FoodsViewHolder>(
    DiffCallback()
) {
